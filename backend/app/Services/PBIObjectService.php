...
class PBIObjectService
{
	...
	public function show($request)
	{
		...
		$render = $this->permissionService::hasPermission('BIs.auth.bis.powerbi');

		$grantOperation = $this->grantOperation('show');
		if ($grantOperation !== true && !$render) return $grantOperation;
	...
	public function render($request)
	{
		try {
			...
			return Que::passa(true, 'auth.bis.rendered', '', $this->object, ['params' => $params]);
		} catch (Exception $e) {
