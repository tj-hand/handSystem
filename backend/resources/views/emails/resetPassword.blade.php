...
<head>
	<title>{{ __('email_reset_password.title') }}</title>
</head>
	...
	<table
		...
		<tr>
			<td style="padding: 0 20px">
				<h2 style="color:#0d203a; margin: 25px 0 0 0;">{{ __('email_reset_password.title') }}</h2>
			</td>
		</tr>
		<tr>
			<td style="padding: 0; margin: 3px 0;">
				<p style="padding: 0 20px; color: #444444;">
					{{ __('email_reset_password.line_1') }}<br>
					{{ __('email_reset_password.line_2') }}
				</p>
			</td>
		</tr>
		<tr>
			<td style="padding: 0; margin: 3px 0;">
				<p style="padding: 0 20px; color: #444444;">
					{{ __('email_reset_password.line_3') }}
				</p>
			</td>
		</tr>
		<tr>
			<td style="padding: 0; margin: 3px 0;">
				<a href="{{ $resetLink }}"
					...
					{{ __('email_reset_password.button_label') }}
				</a>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td style="padding: 20px; color: #444444;">
				<p></p>
				<p style="padding: 0; margin: 0;">{{ __('email_reset_password.farewell') }},</p>
				<p style="padding: 0; margin: 0;"><strong>{{ __('email_reset_password.signature') }}</strong></p>
			</td>
		</tr>
	</table>
</body>
